...
export async function PATCH(request) {
  ...
  const updateItem = await menuItemService.updateMenuItem(formData.get('id'), formData.get('name'), formData.get('description'), formData.get('price'), formData.get('categoryGroup'),formData.get('file'))
...
//   const newItem = await menuItemService.createMenuItem(formData.get('name'), formData.get('description'), formData.get('price'), formData.get('categoryGroup'),  formData.get('file'))
//   return NextResponse.json({ "message": newItem})
// }